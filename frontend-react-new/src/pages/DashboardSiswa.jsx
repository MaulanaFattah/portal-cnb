...
function DashboardSiswa() {
  ...
  const exportAbsensi = () => {
    ...
    anchor.href = url;
    anchor.download = `absensi-saya-${filter.dari}-${filter.sampai}.csv`;
    anchor.click();
      ...
      <div className="teacher-grid two-columns">
        <article className="teacher-card">
          ...
          <div className="teacher-profile-list">
            <div><span>Visi</span><strong>{info?.visi || "Belum diisi"}</strong></div>
            <div><span>Misi</span><strong>{info?.misi || "Belum diisi"}</strong></div>
          </div>
        </article>
